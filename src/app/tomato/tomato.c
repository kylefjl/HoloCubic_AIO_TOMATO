...
void display_tomato_init(void)
{
    ...
    title_label = lv_label_create(tomato_scr, NULL);
    cur_ver_label = lv_label_create(tomato_scr, NULL);
    new_ver_label = lv_label_create(tomato_scr, NULL);
    qq_label = lv_label_create(tomato_scr, NULL);
    author_label = lv_label_create(tomato_scr, NULL);
}
